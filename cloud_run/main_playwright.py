...
from instagram_network_capture_playwright import capturar_multiplas_paginas
...
def main():
    """Função principal para executar o job com Playwright"""
    print("=" * 60)
    print("🚀 INSTAGRAM DATA CAPTURE - Cloud Run Job (Playwright)")
    print("=" * 60)
    print()
